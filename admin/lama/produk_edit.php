  ...
  <section class="content">
    ...
    <div class="row">
         	  <div class="form-group col-lg-6">
                ...
                <input type="number" class="form-control" name="harga_grosir" required="required" placeholder="Harga Jual .. (Wajib)" value="<?php echo $d['produk_harga_grosir']; ?>">
              </div>
			    <div class="form-group col-lg-6">
                <label>Harga Jual RESELER</label>
                <input type="number" class="form-control" name="harga_reseler" required="required" placeholder="Harga Jual .. (Wajib)" value="<?php echo $d['produk_harga_reseler']; ?>">
              </div>
              </div>
              <div class="form-group">
