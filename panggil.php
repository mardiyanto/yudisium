    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        <div class="container">
          ...
          <a href="tampil_datamhs.php" class="btn btn-primary btn-lg active" role="button" aria-pressed="true" target="_blank">SLIDE</a>
            <a href="ajak.php" class="btn btn-primary btn-lg active" role="button" aria-pressed="true" target="_blank">PANGGILAN</a>
          </section><!-- /.content -->
        </div><!-- /.container -->
      </div><!-- /.content-wrapper -->
